...
# Manager app
router.register(
    r'workout', manager_api_views.WorkoutViewSet, base_name='workout')
router.register(
    r'workoutsession', manager_api_views.WorkoutSessionViewSet, base_name='workoutsession')
router.register(
    r'schedulestep', manager_api_views.ScheduleStepViewSet, base_name='schedulestep')
router.register(
    r'schedule', manager_api_views.ScheduleViewSet, base_name='schedule')
...
router.register(
    r'exercisecategory', exercises_api_views.ExerciseCategoryViewSet, base_name='exercisecategory')
router.register(
    r'exerciseimage', exercises_api_views.ExerciseImageViewSet, base_name='exerciseimage')
router.register(
...
# Nutrition app
router.register(
    r'ingredient', nutrition_api_views.IngredientViewSet, base_name='api-ingredient')
router.register(
    r'weightunit', nutrition_api_views.WeightUnitViewSet, base_name='weightunit')
router.register(
    r'ingredientweightunit', nutrition_api_views.IngredientWeightUnitViewSet,
    base_name='ingredientweightunit')
router.register(
    r'nutritionplan', nutrition_api_views.NutritionPlanViewSet, base_name='nutritionplan')
...
urlpatterns = i18n_patterns(
    ...
    url(
        r'software/', include('wger.software.urls', namespace='software', app_name='software')),
    url(
        r'config/', include('wger.config.urls', namespace='config', app_name='config')),
...
urlpatterns += [
    url(r'^robots\.txt$',
        ...
        name='robots'),
    url(
        r'^manifest\.webapp$', WebappManifestView.as_view(
            template_name="manifest.webapp")),
    url(
        r'^amazon-manifest\.webapp$', WebappManifestView.as_view(

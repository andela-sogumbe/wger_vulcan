    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(verbose_name='Description',
                                   help_text='A description of what is done on this day (e.g. "Pull day")'
        ...
        migrations.AlterField(
            model_name='schedule',
            name='is_loop',
            field=models.BooleanField(verbose_name='Is a loop', default=False,
                                      help_text='Tick the box if you want to repeat the schedules in a loop'
        ...
        migrations.AlterField(
            ...
            name='impression',
            field=models.CharField(verbose_name='General impression', default='2', choices=[('1', 'Bad'),
                                                                                            ('2', 'Neutral'),
                                                                                            ('3', 'Good')],

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(help_text='Ususally a description about what parts are trained,'
                                                           'like "Arms" or "Pull Day"',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('name', models.CharField(help_text="Name or short description of the schedule."
                                                    "For example 'Program XYZ'.", max_length=100, verbose_name='Name')),
                ('start_date', wger.utils.fields.Html5DateField(default=datetime.date.today,
                                                                verbose_name='Start date')),
                ('is_active', models.BooleanField(default=True,
                                                  help_text='Tick the box if you want to mark this schedule as your'
                                                            'active one (will be shown e.g. on your dashboard). '
                                                            'All other schedules will then be marked as inactive',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('duration', models.IntegerField(default=4, help_text='The duration in weeks', verbose_name='Duration',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sets', models.IntegerField(default=4, verbose_name='Number of sets',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(help_text="A short description or goal of the workout."
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('date', wger.utils.fields.Html5DateField(verbose_name='Date')),
                ('notes', models.TextField(help_text='Any notes you might want to save about this workout session.',
                                           null=True, verbose_name='Notes', blank=True)),
                ('impression', models.CharField(default=b'2',
                                                help_text='Your impression about this workout session.'
                                                          'Did you exercise as well as you could?',
                                                max_length=2, verbose_name='General impression',

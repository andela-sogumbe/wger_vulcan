    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.CharField(verbose_name='Payment type', default='3',
                                             help_text='How often the amount will be charged to the member',
                                             choices=[('1', 'Yearly'), ('2', 'Half yearly'), ('3', 'Monthly'),
                                                      ('4', 'Biweekly'), ('5', 'Weekly'), ('6', 'Daily')],
                                             max_length=2)),
                ('is_active', models.BooleanField(verbose_name='Contract is active', default=True)),
                ('date_start', models.DateField(verbose_name='Start date', blank=True, default=datetime.date.today,
                                                null=True)),

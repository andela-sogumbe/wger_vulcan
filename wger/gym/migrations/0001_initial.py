    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(related_name='adminusernote_member', editable=False,
                                             to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(related_name='adminusernote_user', editable=False,
                                           to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['name'],
                'permissions': (('gym_trainer', 'Trainer, can see the users for a gym'),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('overview_inactive', models.BooleanField(default=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('weeks_inactive', models.PositiveIntegerField(default=4, help_text='Number of weeks since the last '
                                                                                    'time a user logged his presence '
                                                                                    'to be considered inactive',
                                                               max_length=2, verbose_name='Reminder inactive members')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('include_inactive', models.BooleanField(default=True, help_text='Include this user in the email list '
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp_created', models.DateTimeField(auto_now_add=True)),
                ('timestamp_edited', models.DateTimeField(auto_now=True)),
                ('document', models.FileField(upload_to=wger.gym.models.gym_document_upload_dir,
                                              verbose_name='Document')),
                ('original_name', models.CharField(max_length=128, editable=False)),
                ('name', models.CharField(help_text='Will use file name if nothing provided',
                                          max_length=60, verbose_name='Name', blank=True)),
                ('note', models.TextField(null=True, verbose_name='Note', blank=True)),
                ('member', models.ForeignKey(related_name='userdocument_member', editable=False,
                                             to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(related_name='userdocument_user', editable=False,
                                           to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-timestamp_created'],

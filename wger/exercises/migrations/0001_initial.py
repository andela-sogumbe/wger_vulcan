    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license_author', models.CharField(
                    ...
                    blank=True)),
                ('status',
                 models.CharField(default=b'1', max_length=2, editable=False,
                                  choices=[(b'1', 'Pending'),
                                           (b'2', 'Accepted'),
                                           (b'3', 'Declined')])),
                ('description',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exercise',
                 models.ForeignKey(editable=False, to='exercises.Exercise',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exercise', models.ForeignKey(verbose_name='Exercise',
                                               to='exercises.Exercise')),
                ('license',
                 models.ForeignKey(default=2, verbose_name='License',
                                   to='core.License')),
            ],
            options={
                'ordering': ['-is_main', 'id'],
        ...
        migrations.AddField(
            model_name='exercise',
            name='equipment',
            field=models.ManyToManyField(to='exercises.Equipment', null=True,
                                         verbose_name='Equipment', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='exercise',
            name='language',
            field=models.ForeignKey(verbose_name='Language',
                                    to='core.Language'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='exercise',
            name='license',
            field=models.ForeignKey(default=2, verbose_name='License',
                                    to='core.License'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='exercise',
            name='muscles',
            field=models.ManyToManyField(to='exercises.Muscle', null=True,
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='secondary_muscles',
                                         null=True,
                                         verbose_name='Secondary muscles',
                                         to='exercises.Muscle', blank=True),
            preserve_default=True,
        ),
    ]

    ...
    operations = [
            ...
            fields=[
                ...
                ('license_author', models.CharField(
                    help_text='If you are not the author, enter the name or source here. '
                              'This is needed for some licenses e.g. the CC-BY-SA.',
                    max_length=50, null=True, verbose_name='Author', blank=True)),
                ('status', models.CharField(default=b'1', max_length=2, editable=False,
                ...
                ('protein',
                 models.DecimalField(help_text='In g per 100g of product', verbose_name='Protein', max_digits=6,
                                     decimal_places=3, validators=[django.core.validators.MinValueValidator(0),
                                                                   django.core.validators.MaxValueValidator(100)])),
                ('carbohydrates',
                 models.DecimalField(help_text='In g per 100g of product', verbose_name='Carbohydrates', max_digits=6,
                                     decimal_places=3, validators=[django.core.validators.MinValueValidator(0),
                                                                   django.core.validators.MaxValueValidator(100)])),
                ('carbohydrates_sugar', models.DecimalField(decimal_places=3,
                                                            validators=[django.core.validators.MinValueValidator(0),
                                                                        django.core.validators.MaxValueValidator(100)],
                                                            max_digits=6, blank=True,
                                                            help_text='In g per 100g of product', null=True,
                                                            verbose_name='Sugar content in carbohydrates')),
                ('fat', models.DecimalField(help_text='In g per 100g of product', verbose_name='Fat', max_digits=6,
                                            decimal_places=3, validators=[django.core.validators.MinValueValidator(0),
                ...
                ('fat_saturated', models.DecimalField(decimal_places=3,
                                                      validators=[django.core.validators.MinValueValidator(0),
                                                                  django.core.validators.MaxValueValidator(100)],
                                                      max_digits=6, blank=True, help_text='In g per 100g of product',
                                                      null=True, verbose_name='Saturated fat content in fats')),
                ('fibres', models.DecimalField(decimal_places=3,
                                               validators=[django.core.validators.MinValueValidator(0),
                                                           django.core.validators.MaxValueValidator(100)], max_digits=6,
                                               blank=True, help_text='In g per 100g of product', null=True,
                                               verbose_name='Fibres')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(default=1, help_text='Unit amount, e.g. "1 Cup" or "1/2 spoon"',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight_unit',
                 models.ForeignKey(verbose_name='Weight unit', blank=True, to='nutrition.IngredientWeightUnit',
                                   null=True)),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(
                    ...
                    max_length=2000, verbose_name='Description', blank=True)),
                ('has_goal_calories', models.BooleanField(default=False,
                                                          help_text='Tick the box if you want to mark this plan as '
                                                                    'having a goal amount of calories. You can use the '
                                                                    'calculator or enter the value yourself.',
